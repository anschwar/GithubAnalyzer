 ...
 *       &lt;sequence>
 *         &lt;element ref="{}textMatch" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "textMatches")
public class TextMatches {

    @XmlElement(required = true)
    protected List<String> textMatch;
     ...
     * 
     */
    public List<String> getTextMatch() {
        if (textMatch == null) {
            textMatch = new ArrayList<String>();
        }
